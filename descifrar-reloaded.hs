...
reversoletANat x = agarra x (zip ['a','b'..'z'] [25,24..0]) -- hace lo mismo que letANat pero le asigna el 25 a la a y el 0 a la z (utilizando la la funcion auxiliar equivalente)

reversonatALet :: Integer -> Char
reversonatALet x = agarra2 x (zip [0,1..25] ['z','y'..'a']) -- es como natALet pero el 0 devuelve la z y el 25 la a (utilizando la la funcion auxiliar equivalente)
